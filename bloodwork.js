...
window.BLOODWORK =
{
 ...
 "MARK": [
  ...
  },
  {
   ...
   "note": "A protein that sits on every particle capable of lodging in an artery wall — LDL, VLDL and Lp(a) — exactly one copy each.\n\nSo ApoB counts the particles directly, rather than measuring the cholesterol they happen to be carrying. That matters when the two disagree: two people with identical LDL can carry very different particle numbers, and the particle count is what tracks risk.\n\nIt is also immune to the triglyceride level that distorts calculated LDL.\n\nWHY THIS ONE IS MORE THAN A CORRELATION. Most biomarkers only travel alongside disease. This one has been tested two ways. People born with genes that keep ApoB low get less heart disease, and dozens of different genes all show it. And drugs that lower ApoB — statins, ezetimibe, PCSK9 inhibitors — cut events in proportion to how far they lower it, whichever way they work. Many different routes, the same result each time.\n\nIT ADDS UP OVER YEARS. What damages an artery is not one reading but the total exposure: how high, for how long. So the same number matters more at 30 than at 60, because there are more years left to accumulate. A small difference held for decades beats a large correction made late.\n\nWHEN IT DISAGREES WITH LDL, TRUST APOB. Sometimes LDL looks fine while ApoB is high. That happens when the particles are small and carry less cholesterol each, which is common with high triglycerides or insulin resistance. In that situation the particle count is what tracks risk.\n\nWHAT MOVES IT. Swapping saturated fat for unsaturated is the main dietary lever — about 1.5-2 mg/dL of LDL for every 1% of calories exchanged. Soluble fibre adds a few percent, plant sterols a few more. Losing visceral fat helps mainly through triglycerides. Past that, the things that work are drugs.\n\nONE ASSAY CAVEAT. It is measured directly, so it escapes the estimating formulas that distort calculated LDL. But labs calibrate against different standards, so switching lab can shift the number on its own.",
   "axis": [
    0,
    160
   ],
  ...
  },
  {
   ...
   "note": "The cholesterol carried on LDL particles, and the main target of lipid treatment.\n\nUsually not measured. Most labs calculate it from total cholesterol, HDL and triglycerides using a formula that assumes a fixed relationship between them. That assumption breaks down in the two places it matters most:\n\n• When LDL is low, the estimate drifts\n• When triglycerides are high, it under-reports\n\nWorth knowing whether a given result was measured directly or calculated.\n\nWHICH FORMULA WAS USED MATTERS. Friedewald is the old one. It breaks down below about 70 mg/dL, and above 400 mg/dL of triglycerides. Martin-Hopkins adjusts to each sample instead of using one fixed factor, and is clearly better at low LDL. Sampson was built for the high-triglyceride end. A lab that switches formula changes your number without anything changing in you, so it is worth recording which one printed the result.\n\nIT CAUSES THE DISEASE, IT DOES NOT JUST PREDICT IT. People born with genes that keep LDL low get less heart disease. Drugs that lower it cut events in proportion to how far they lower it, whichever way they work. And what counts is the total over time, not one reading, so the same value weighs more the younger you are.\n\nWHY APOB IS OFTEN THE BETTER NUMBER. This measures the cholesterol being carried. ApoB counts the particles carrying it. The two can disagree — usually when triglycerides are high or insulin sensitivity is poor, and the particles run small. Then this one reads reassuringly while the particle count is high.\n\nWHAT MOVES IT. Swapping saturated fat for unsaturated does the most: about 1.5-2 mg/dL for every 1% of calories exchanged. Add 5-10g of soluble fibre a day for roughly another 5%, and 2g of plant sterols for 8-10%. Losing visceral fat works mostly through triglycerides. They stack, but they are all modest — a large gap will not close on diet alone.\n\nTHE CUT-OFFS ARE LINES DRAWN ON A SLOPE. 130 and 190 mg/dL are where guidelines chose to act. Nothing changes in the artery at those numbers; risk climbs steadily from well below them. Being under one means less exposure, not none.",
   "axis": [
    0,
    190
   ],
