   ...
   },
   {
    ...
    "v": {
     ...
     "egfr": {
      "r": 61,
      "u": "mL/min/1.73m²",
      "cx": "ON CREATINE — computed from the raised creatinine, so the dip is the supplement, not a fall in filtration",
      "a": "Equation CKD-EPI"
     },
     "ast": {
      "r": 25,
