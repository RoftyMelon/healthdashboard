...
window.BLOODWORK =
{
 ...
 "MARK": [
  ...
  },
  {
   ...
   "note": "Phosphate is a mineral that works with calcium to build bone. Cells also use it to store and transfer energy and to make DNA.\n\nThe kidneys, PTH and vitamin D keep its blood level controlled. PTH usually raises calcium while lowering phosphate.\n\nRead phosphate alongside calcium, PTH, vitamin D and kidney function. An isolated result rarely tells the full story.",
   "axis": [
    1.5,
    6
   ]
  ...
  },
  {
   ...
   "note": "Homocysteine is a substance produced while the body processes methionine, an amino acid found in protein.\n\nFolate, vitamin B12 and vitamin B6 help clear it. A high result can point to a shortage in one of those vitamins, but kidney function, thyroid function, medicines and genetics can also affect it.\n\nSample handling matters: homocysteine can rise if blood cells are not separated from the plasma promptly. Lowering the number with B vitamins has not consistently improved health outcomes, so treat it as a clue rather than a target on its own.",
   "axis": [
    0,
    20
   ],
  ...
  },
  {
   ...
   "note": "Ceruloplasmin is the main protein that carries copper in the blood. Measuring it with serum copper helps distinguish too little copper from too little of the protein carrying it.\n\nInflammation and oestrogen exposure can raise ceruloplasmin. Laboratories also use different methods that are not directly interchangeable, so compare results only when the method is compatible.",
   "axis": [
    8,
    45
   ]
  ...
  },
  {
   ...
   "note": "Methylmalonic acid, or MMA, rises when cells do not have enough usable vitamin B12. It can reveal a functional B12 shortage even when serum B12 is borderline or appears normal.\n\nThe kidneys clear MMA, so reduced kidney function can also raise it. Read it alongside serum B12, kidney function, symptoms and the laboratory's own reference information.",
   "axis": [
    0,
    500
   ],
  ...
  },
  {
   ...
   "note": "PLP is the active form of vitamin B6 and is usually the preferred blood marker for B6 status.\n\nVitamin B6 helps enzymes process amino acids, including the pathway that clears homocysteine. A low PLP result can therefore help explain an elevated homocysteine result.\n\nInflammation and sample handling can also lower PLP, so interpret it with the wider clinical and laboratory context.",
   "axis": [
    0,
    180
   ],
  ...
  },
  {
   ...
   "note": "ApoB is a protein carried by particles that can enter an artery wall, including LDL, VLDL and Lp(a). Each particle carries one ApoB molecule, so the result is a practical count of these particles.\n\nThe amount of cholesterol and the number of particles can disagree. When they do, ApoB often gives the clearer picture of cardiovascular risk, particularly when triglycerides are high or insulin sensitivity is poor.\n\nRisk reflects both the ApoB level and how many years that exposure lasts. ApoB is measured directly, but a change of laboratory or calibration can still shift the result.",
   "axis": [
    0,
    160
   ],
  ...
  },
  {
   ...
   "note": "LDL cholesterol estimates how much cholesterol is being carried by LDL particles. Higher exposure over many years contributes directly to plaque building in arteries.\n\nMost laboratories calculate LDL from total cholesterol, HDL and triglycerides. The formula matters, especially when LDL is low or triglycerides are high, so record whether the result was measured or calculated and which formula was used.\n\nLDL and ApoB can disagree because LDL measures cholesterol while ApoB counts particles. Cardiovascular risk rises gradually rather than beginning at one sharp cutoff.",
   "axis": [
    0,
    190
   ],
  ...
  },
  {
   ...
   "note": "Albumin is the most abundant protein in blood. It carries hormones, medicines and calcium, and helps keep fluid inside blood vessels.\n\nIts level can change with liver function, inflammation, hydration, nutrition, or protein loss through the kidneys or gut.\n\nAlbumin is also used to calculate adjusted calcium and free testosterone. Those calculated results therefore inherit any error or method difference in the albumin measurement.",
   "axis": [
    3,
    5.5
   ]
  },
  {
   ...
   "note": "Prothrombin time measures how quickly blood plasma forms a clot through one part of the clotting system. It depends on several clotting proteins made by the liver, many of which require vitamin K.\n\nLaboratories may report it in seconds, as INR, or as a percentage of normal activity. These formats are not interchangeable.\n\nAn abnormal result can reflect anticoagulant treatment, vitamin K deficiency, liver dysfunction or a clotting-factor problem. INR is used mainly to standardize results when monitoring vitamin K antagonist treatment such as warfarin.",
   "axis": [
    40,
    120
   ]
  },
  {
   ...
   "note": "aPTT measures a different part of the clotting system from prothrombin time. Laboratories report it in seconds or relative to their own control, and methods vary.\n\nA prolonged result can be caused by a clotting-factor deficiency, heparin or certain antibodies. It does not automatically mean that someone will bleed.\n\nInterpret it with prothrombin time, medicines, symptoms and the laboratory method. It is also used in some settings to monitor unfractionated heparin.",
   "axis": [
    0.6,
    1.6
   ]
  ...
  },
  {
   ...
   "note": "Free testosterone is the small portion of testosterone not bound to carrier proteins. Equilibrium dialysis physically separates it from bound testosterone and is considered a reference measurement method when paired with an accurate testosterone assay.\n\nIt is not interchangeable with calculated free testosterone, and each method needs its own reference interval.\n\nIf the two methods are being compared, measure total testosterone, SHBG and albumin from the same sample and keep the laboratory method consistent.",
   "axis": [
    40,
    400
   ]
  ...
  },
  {
   ...
   "note": "Prolactin is a hormone made by the pituitary gland. A persistently high level can suppress reproductive hormone function and lower testosterone.\n\nStress, sleep, recent exercise, medicines, an underactive thyroid and kidney disease can all raise it. Some assays also detect macroprolactin, a largely inactive form that can make the total appear high.\n\nAn unexpected elevation is usually repeated under standardized conditions before investigating medicines or pituitary causes.",
   "axis": [
    0,
    30
   ]
  ...
  },
  {
   ...
   "note": "MCH tells you how much haemoglobin the average red blood cell carries. Larger cells usually carry more, so MCH often follows MCV.\n\nWhen MCH and MCV do not match, that difference can help explain an abnormal blood count.",
   "axis": [
    22,
    38
   ]
  ...
  },
  {
   ...
   "note": "Magnesium helps the body use energy and supports normal nerve, muscle and heart function.\n\nLess than one percent of the body's magnesium is present in serum, and the body keeps that level tightly controlled. A normal serum result therefore does not prove that total stores are adequate, although the test remains useful for detecting important abnormalities in the blood.\n\nRed-cell magnesium also lacks universal standardization and is not a definitive measure of total body stores.",
   "axis": [
    1.4,
    2.8
   ]
  ...
  },
  {
   ...
   "note": "Bicarbonate helps keep the blood's acidity stable. A routine chemistry panel usually estimates it by measuring total carbon dioxide, or total CO₂.\n\nA low or high result can reflect several kidney, metabolic or breathing-related conditions, so interpret it with chloride, the anion gap, kidney function and, when needed, a blood-gas test.\n\nCarbon dioxide can escape from an underfilled, open or delayed sample and make the result falsely low. An isolated unexpected result often needs confirmation.",
   "axis": [
    15,
    35
   ]
  ...
  },
  {
   ...
   "note": "IGF-1 carries many of the effects of growth hormone. Growth hormone is released in short pulses, while IGF-1 remains steadier, making it a more practical marker of the growth-hormone system.\n\nAge, nutrition, liver or kidney disease, diabetes and some medicines can affect it. An abnormal result does not establish a diagnosis by itself.\n\nThere is no proven universal longevity target for IGF-1. Observational associations do not show that deliberately raising or lowering it improves health.",
   "axis": [
    60,
    280
   ]
