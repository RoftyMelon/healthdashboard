...
window.BLOODWORK =
{
 ...
 "STACK": {
  ...
  "items": [
   ...
   {"id": "ha", "name": "Hyaluronic acid", "dose": "200mg", "info": "Not deposited intact — ~0.2% bioavailable; gut bacteria fragment it to oligosaccharides that signal the skin's own HA synthesis. 2025 meta-analysis (7 RCTs): modest hydration, elasticity and wrinkle gains — no clear dose-response across 60-240mg, so form beats dose (favour low-MW/oligo). Cosmetic, microbiome-dependent.", "cat": "skin", "status": "planned", "when": null, "url": null, "dec": null},
