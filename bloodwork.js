...
window.BLOODWORK =
{
 ...
 "STACK": {
  ...
  "items": [
   ...
   {"id": "lyco", "name": "Lycopene", "dose": "15mg 2x/day", "info": "Red tomato carotenoid — a genuine skin-coloration carotenoid (warm tone) plus photoprotection (raises the UV-burn threshold at 10-16mg). Plasma saturates by ~30-40mg, so 50mg was mostly excreted; 30mg (15mg 2x, fatty meals) captures it, within the EFSA ADI (40mg at 80kg). Tomato-derived (LycoBeads) beats synthetic; cooked tomato + olive oil beats raw.", "cat": "skin", "status": "taking", "when": null, "url": "https://www.sunday.de/en/lycopene-capsules.html", "dec": null},
   {"id": "vitd3k2", "name": "Vitamin D3 + K2", "dose": "5000 IU", "info": "Titrate 5000 IU to blood 25-OH-D (~40-60 ng/mL), not on autopilot; K2 MK-7 steers the calcium to bone. Already taking — a baseline-draw confound.", "cat": "essentials", "status": "taking", "when": null, "url": "https://www.sunday.de/en/vitamin-d-tablets-5000-iu-plus-k2-mk7-100mcg-xl.html", "dec": "Vitamin D3 5000 IU + K2"},
   ...
   {"id": "minoxidil", "name": "Minoxidil (topical)", "dose": "5-10%, 1mL 2x/day", "info": "Topical vasodilator for regrowth — ~1.4% systemic absorption, no hormonal mechanism. Not started; no blood marker tracks it.", "cat": "hair", "status": "planned", "when": null, "url": null, "dec": null},
   ...
   {"id": "tretinoin", "name": "Tretinoin / retinoic acid (topical)", "dose": "0.01%, 1mL", "info": "Candidate: upregulates follicular absorption, boosting topical minoxidil's uptake. Hair-protocol adjunct, not committed.", "cat": "hairlater", "status": "candidate", "when": null, "url": null, "dec": null},
   {"id": "ketoconazole", "name": "Ketoconazole (topical)", "dose": "2%, 1mL 3x/week", "info": "Candidate: anti-DHT + anti-inflammatory scalp action (Nizoral) — a modest androgenetic-alopecia adjunct. Not committed.", "cat": "hairlater", "status": "candidate", "when": null, "url": null, "dec": null}
  ]
 },
 "ROUTINE": [
