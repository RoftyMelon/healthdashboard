...
window.BLOODWORK =
{
 ...
 "NEXTDRAW": {
  "items": [
   ...
   {
    "en": "Free testosterone by EQUILIBRIUM DIALYSIS — ONCE, to see which scale describes you — a direction, not a permanent coefficient (ask B2A first; fallback: bioavailable T by ammonium sulphate precipitation, never a direct immunoassay)",
