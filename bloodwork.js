...
window.BLOODWORK =
{
 ...
 "MARK": [
  ...
  },
  {
   ...
   "note": "The total number of immune cells in circulation. A broad screen for infection, inflammation and bone-marrow function.\n\nThe total by itself is fairly blunt — nearly all the information is in the breakdown below it, since a high count from neutrophils means something very different from a high count from lymphocytes.\n\nRises briefly with acute stress, adrenaline, and recent hard exercise, none of which involve illness.\n\nNO OPTIMIZATION TARGET, DELIBERATELY. Any band here would point UPWARD, and the mortality curve is J-shaped rather than a slope: risk climbs steadily above about 6 and is flat across the low-normal zone in people who are not acutely ill, so there was nothing for a lower edge to protect against. A count in the lower half of normal is also common in trained people — the evidence sits in endurance athletes, where elite cyclists and triathletes run well below team-sport athletes, though the effect is only about 0.15. What matters is a TREND, or a fall alongside the other cell lines. Judge one by whether it STOPPED: a decline that settles and then holds for years, driven by one line only — neutrophils, with lymphocytes and the red indices unmoved — is a new set point, not a signal, and a fall that also spans a change of laboratory and analyser is partly measurement. The number that decides whether a low white count is worth working up is the absolute neutrophil count, and the threshold is 1500.",
   "axis": [
    2,
    13
   ]
