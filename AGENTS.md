...
- **A DIET tooltip has FIVE sections, in this order**: `Ingredients` (what it is made of) →
  ...
  **The Brunch `Seafood starter` row is a pointer, not a fifth seafood item.** Its 166kcal is the
  equal-weight mean of the four current Weekly servings (212, 250, 99 and 103kcal) and exists so
