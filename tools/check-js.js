...
setTimeout(()=>{
  ...
  try{ setPage('routine');
    ...
    ok('gym phase icons sit in their respective time slots',
      count(RH,'rphase')===4&&
      RH.includes('class="rphase rphase-car" role="img" aria-label="Commute" style="top:calc(62.5% + 7px)">🚙</span>')&&
    ...
    ok('routine emojis share one visually calibrated column',count(RH,'rdo ricon')===8&&count(RH,'rphase')===4&&
      ...
      html.includes('.rdo.ricon.rpair{margin-left:1px}')&&
      RH.includes('class="rdo ricon rpair">🏃 🥣</div>'),
